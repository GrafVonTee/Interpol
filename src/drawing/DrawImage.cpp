...
void draw_triangles_and_intersection(const ImVec2& a1, const ImVec2& a2, const ImVec2& a3, const ImVec2& b1, const ImVec2& b2, const ImVec2& b3, const std::vector<ImVec2>& intersection_points, const char* filename) {
    // create a new image
    ...
    // convert the image to PNG and save it to a file
    stbi_write_png(filename, 512, 512, 3, img, 0);
